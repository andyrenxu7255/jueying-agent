# TeamClaw (Agent Harness) 🦞

> **企业级 AI Agent 编排与执行平台** — 多渠道接入、LLM 任务规划、多阶段工作流自动执行
...
TeamClaw（内部代号 agent-harness）是一个**企业级 AI Agent 编排与执行平台**。
...
| 🧠 **LLM 任务规划** | 用户意图自动拆解为 development / knowledge 类型多阶段工作流 |
...
```bash
git clone https://github.com/andyrenxu7255/agent-harness.git
cd agent-harness
```
...
| [用户故事线](./用户故事线.md) | 19 条验收故事线 (AH-1 ~ AH-19)，覆盖全部功能场景 |
| [修复报告](./FIX-REPORT.md) | 代码审计与修复记录 |
| [交接文档](./HANDOFF-SESSION.md) | 开发历史、7 轮修复详情、当前系统状态 |
