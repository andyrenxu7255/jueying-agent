...
| **技术栈** | TypeScript + Node.js 22 + Express/Fastify |
...
| **代码质量要求** | ✅ TypeScript strict mode<br>✅ ESLint + Prettier 配置<br>✅ 全局 Jest 语句/分支/函数/行覆盖率均 ≥ 95%<br>✅ API 文档（OpenAPI 3.0）<br>✅ 错误码统一管理 |
...
| **代码质量要求** | ✅ 类型定义完整（interfaces/types）<br>✅ 异步编程规范（async/await）<br>✅ 错误传播链路清晰<br>✅ 关键路径日志完备<br>✅ 全局 Jest 语句/分支/函数/行覆盖率均 ≥ 95% |
...
| **代码质量要求** | ✅ 输入验证严格（防注入）<br>✅ 资源限制强制执行（CPU/内存/时间）<br>✅ 执行日志完整可追溯<br>✅ 清理机制可靠（无残留）<br>✅ 全局 Jest 语句/分支/函数/行覆盖率均 ≥ 95%（安全相关核心路径保持重点覆盖）|
...
| 模块 | 行覆盖率 | 分支覆盖率 | 函数覆盖率 |
|------|----------|------------|------------|
| Gateway Adapter | ≥ 95% | ≥ 95% | ≥ 95% |
| Workflow Engine | ≥ 95% | ≥ 95% | ≥ 95% |
| Planner | ≥ 95% | ≥ 95% | ≥ 95% |
| Retrieval | ≥ 95% | ≥ 95% | ≥ 95% |
| Executor Gateway | ≥ 95% | ≥ 95% | ≥ 95% |
| **全局门禁** | **≥ 95%** | **≥ 95%** | **≥ 95%** |
